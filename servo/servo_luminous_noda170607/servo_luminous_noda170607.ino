...
void servoMove(int js_h_val, int js_v_val){ 
  ...
  sv_pos_H = map(js_h_val,230,900,7263,7737);
  sv_pos_V = map(js_v_val,195,800,7263,7737);

  ics_set_pos(1,sv_pos_H,SV_H);
  ics_set_pos(2,sv_pos_V,SV_V);
}
...
void loop (){
  ...
  Serial.println(ics_set_pos(2,7600,SV_V));
  delay(500);
  Serial.println(ics_set_pos(1,7500,SV_H));
  Serial.println(ics_set_pos(2,7500,SV_V));
  delay(500);
  */
